...
def _patch_graceful_shutdown() -> None:
    try:
        ...
        return
    if getattr(client_mod, "_QUILL_shutdown_patched", False):
        return
    ...
    client_mod._QUILL_shutdown_patched = True
...
def apply() -> None:
    ...
    try:
        ...
        return
    if getattr(bridge_mod, "_QUILL_patched", False):
        return
    ...
    bridge_mod._QUILL_patched = True
